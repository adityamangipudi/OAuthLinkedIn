...
/* GET home page. */
router.get('/linkedin', passport.authenticate('linkedin', { state: '7e12584c96664ddbb15c847450bba435'  }),function(req, res, next) {
...
router.get('/authenticated', function(req, res){
    ...
    res.render('authenticated', {user:profileG.displayName});
});
